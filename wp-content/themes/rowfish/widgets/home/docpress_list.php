 ...
 * @Created_at     : 2021-11-18 05:41:31 +0800
 * @Updated_at     : 2021-11-23 10:07:22 +0800
 * @Path           : /wp-content/themes/rowfish/widgets/home/docpress_list.php
 * @Description    : 首页文档列表小工具
 ...
 * 分类CMS文章展示块
 */
CSF::createWidget('rf_home_dospress_list_widget', array(
    'title'       => esc_html__('RF: 首页-文档模块', 'rizhuti-v2'),
...
if (!function_exists('rf_home_dospress_list_widget')) {
    function rf_home_dospress_list_widget($args, $instance)
    {
