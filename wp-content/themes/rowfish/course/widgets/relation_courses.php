 ...
 * @Created_at     : 2021-11-11 03:59:57 +0800
 * @Updated_at     : 2021-11-19 05:31:21 +0800
 * @Path           : /wp-content/themes/rowfish/course/widgets/relation_courses.php
 * @Description    : 视频课程侧边栏的相关课程小工具
 ...
 * 侧边栏分类文章展示
 */
CSF::createWidget('rf_relation_courses_widget', array(
    'title'       => esc_html__('RF: 相关课程侧边栏', 'rizhuti-v2'),
    'classname'   => 'rizhuti_v2-widget-post',
    'description' => esc_html__('与当前文章同一个专题下/分类下的课程展示', 'rizhuti-v2'),
    'fields'      => array(
        array(
            'id'    => 'title',
            'type'  => 'text',
...
if (!function_exists('rf_relation_courses_widget')) {
    function rf_relation_courses_widget($args, $instance)
    {
