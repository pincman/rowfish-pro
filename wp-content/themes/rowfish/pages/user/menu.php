 ...
 * @Updated_at     : 2021-11-19 05:20:14 +0800
 * @Path           : /wp-content/themes/rowfish/pages/user/menu.php
 * @Description    : 用户中心左侧菜单
  ...
  <div id="sidebarNav" class="collapse navbar-collapse navbar-vertical">
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <h6 class="text-cap small text-muted"><?php echo esc_html__('账号信息', 'rizhuti-v2'); ?></h6>
