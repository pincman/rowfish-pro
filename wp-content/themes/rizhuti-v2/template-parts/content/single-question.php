  ...
  foreach ( $items as $item ) { ?>
    ...
    <div class="question-item">
      <header>
        ...
        <span class="meta-author">
          <?php echo sprintf( __( '%s前','rizhuti-v2' ), human_time_diff( strtotime($item->comment_date), current_time( 'timestamp' ) ) );echo esc_html__(' 回答','rizhuti-v2');?>
        </span>
      </header>
...
<form id="comments" class="question-form">
    ...
    <div class="question-form-area">
        ...
        <textarea name="content" placeholder="输入回答内容..." class="form-control" rows="6"></textarea>
    </div>
