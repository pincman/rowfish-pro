    ...
    <div class="docspress-single-sidebar-wrap">
        <?php if ( docspress()->get_option( 'sidebar_show_search', 'docspress_single', true ) ) : ?>
            <form role="search" method="get" class="docspress-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                <input type="search" class="docspress-search-field" placeholder="<?php echo esc_attr__( 'Type to search', 'docspress' ); ?>" value="<?php echo get_search_query(); ?>" name="s" autocomplete="off">
