...
<form class="docspress-single-feedback-suggestion" action="" method="post" style="display: none;">
    <h3><?php echo esc_html__( 'How can we improve this documentation?', 'docspress' ); ?></h3>

    <div>
        <textarea name="suggestion" placeholder="<?php echo esc_attr__( 'Your suggestions', 'docspress' ); ?>" required></textarea>

        <input name="from" type="text" value="<?php echo esc_attr( $from ); ?>" placeholder="<?php echo esc_attr__( 'Your Name or Email (Optional)', 'docspress' ); ?>">

        <button class="docspress-btn docspress-btn-md"><?php echo esc_attr__( 'Send', 'docspress' ); ?></button>
